...
locals {
  ...
  validate_encryption_inputs = (!var.create_cos_instance && var.existing_cos_instance_id == null) && !var.create_cos_bucket ? tobool("var.create_cos_instance and var.create_cos_bucket cannot be both set to false") : true
  # tflint-ignore: terraform_unused_declarations
